...
mytable.add_row(["5", "-", str(matrix[4][5] + fx["f5(x5) - 6"]), str(matrix[4][6]), str(fx["f5(x5) - 5"]), x_star['6* - 5']])
mytable.add_row(["6", str(matrix[5][6]), "-", str(matrix[5][6] + fx["f5(x5) - 6"]), str(fx["f5(x5) - 6"]), x_star['6* - 6']])
...
mytable.add_row(["2", str(matrix[1][2] + fx["f3(x3) - 3"]), str(matrix[3][4] + fx["f3(x3) - 4"]), str(fx["f2(x2) - 2"]), x_star['3* - 2']])
